$(document).ready(function() {
  $(':checkbox').on('click', changeTaskStatus);
});

function changeTaskStatus() {
  putNewStatus(this.getAttribute('data-task-id'), $(this).is(':checked'));
}
...
function putNewStatus(taskID, isFinished) {
